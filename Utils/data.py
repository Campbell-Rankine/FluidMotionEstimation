### - Code for reading data structures in train script - ###
"""
Code was provided at the following link:
https://eulerian.cs.washington.edu/dataset/load_files.py
"""
...
def load_compressed_tensor(filename): #Motion estimation ground truth
    retval = None
...
class VideoReader(object): ### - Video data, helpful later
    """
    Wrapper for PyAV
